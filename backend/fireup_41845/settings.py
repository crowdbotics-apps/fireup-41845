"""
Django settings for fireup_41845 project.
...
ROOT_URLCONF = 'fireup_41845.urls'
...
WSGI_APPLICATION = 'fireup_41845.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fireup_41845 API",
    "DESCRIPTION": "API documentation for fireup_41845 App",
    "VERSION": "v1",
}
